...
/// Cache key for the native cursor:
/// (bitmap_ref, mask_bitmap_ref, reg_point, scale_factor).
///
/// The factor is part of the key because the cursor is rasterised at the stage
/// scale — without it, going fullscreen would keep serving the cached 1x image.
pub type NativeCursorCache = Option<(Option<u32>, Option<u32>, (i16, i16), u32)>;
