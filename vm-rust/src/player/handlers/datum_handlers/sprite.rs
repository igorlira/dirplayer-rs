use crate::player::{
    player_call_script_handler, player_handle_scope_return, reserve_player_ref, reserve_player_mut, script_ref::ScriptInstanceRef, DatumRef, DirPlayer, ScriptError, ScriptErrorCode
};
                ...
                reserve_player_mut(|player| {
                    ...
                    match crate::player::score::sprite_get_prop(player, sprite_num as i16, &prop_name) {
                        Ok(prop_datum) => {
                            ...
                            if args.len() > 1 {
                                return crate::player::handlers::types::TypeUtils::get_sub_prop(&result, &args[1], player);
                            }
