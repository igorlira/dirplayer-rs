            ...
            let instance_ids = reserve_player_mut(|player| {
                ...
                if player.keyboard_focus_sprite != -1 {
                    ...
                    if let Some(sprite) = sprite {
                        ...
                        let member = member_ref.and_then(|x| {
                            player.movie.cast_manager.find_mut_member_by_ref(&x)
                        });
