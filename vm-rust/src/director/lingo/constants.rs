...
pub fn opcode_names() -> &'static HashMap<OpCode, String> {
  static MAP: OnceLock<HashMap<OpCode, String>> = OnceLock::new();
  MAP.get_or_init(|| {
    HashMap::from([
      // single-byte
...
fn anim_prop_names() -> &'static HashMap<u16, String> {
...
fn anim2_prop_names() -> &'static HashMap<u16, String> {
  static MAP: OnceLock<HashMap<u16, String>> = OnceLock::new();
  MAP.get_or_init(|| {
    HashMap::from([
...
pub fn movie_prop_names() -> &'static HashMap<u16, String> {
  static MAP: OnceLock<HashMap<u16, String>> = OnceLock::new();
  MAP.get_or_init(|| {
    HashMap::from([
