...
impl KeyTableEntry {
  pub fn from_reader(reader: &mut BinaryReader, _dir_version: u16) -> Result<KeyTableEntry, String> {
...
pub struct KeyTableChunk {
  pub /* int16 */ entry_size: u16, // Should always be 12 (3 uint32's)
	pub /* int16 */ entry_size2: u16,
	pub entry_count: u32,
	pub used_count: u32,
...
impl KeyTableChunk {
  pub fn from_reader(reader: &mut BinaryReader, dir_version: u16) -> Result<KeyTableChunk, String> {
    ...
    return Ok(KeyTableChunk {
      ...
      entries: (0..entry_count).map(|_| KeyTableEntry::from_reader(reader, dir_version).unwrap()).collect()
    })
  }
}
